...
import std.experimental.graphic.color.conv;
...
@safe: pure: nothrow: @nogc:
    ...
    {
        import std.experimental.graphic.color.conv: colorFromString;
...
{
    import std.experimental.graphic.color.conv: convertPixelType;
