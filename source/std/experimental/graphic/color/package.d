...
*/
module std.experimental.graphic.color;

import std.experimental.graphic.color.rgb;
import std.experimental.graphic.color.xyz : XYZ;
...
/**
Detect whether $(D_INLINECODE T) is a color type compatible with std.experimental.graphic.color.
*/
...
{
    import std.experimental.graphic.color.rgb;
    import std.experimental.graphic.color.hsx;
    import std.experimental.graphic.color.xyz;
...
{
    import std.experimental.graphic.color.hsx;
    import std.experimental.graphic.color.lab;
    import std.experimental.graphic.color.xyz;
